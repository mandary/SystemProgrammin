...
class Point {
 public:
  // Try removing the initializer for refExample,
  // either setting it in the body of the constructor
  // or trying to leave it uninitialized...
  Point(const int x, const int y) : refExample(x) {
    x_ = x;
    y_ = y;
  }
 ...
 private:
  int x_;  // data member -- now a reference, bizarrely
  int y_;   // data member
  //------------------------------------------------------------------
